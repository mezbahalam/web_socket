...
class PlaceBidTest < MiniTest::Test
  def setup
    @user = User.create! email: "mezbah@gmail.com", password: "password"
    @another_user = User.create! email: "mezba@gmail.com", password: "password"
    @product = Product.create! name: "Some"
